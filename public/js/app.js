...
var _class = function () {
    function _class() {
        ...
        // Configure Stuff
        _vue2.default.http.options.root = window.GTALapTimeTracker ? window.GTALapTimeTracker.root : null;
...
},{"vue":17,"vue-resource":15,"vue-router":16}],2:[function(require,module,exports){
...
},{"dom":2,"xtend":12}],14:[function(require,module,exports){
var Vue // late bind
...
exports.default = {
  ...
  init: function init() {
    ...
    _vue2.default.transition('bounce', {
      afterLeave: function afterLeave(el) {
        _store2.default.errors = [];
        this.errors = _store2.default.errors;
      }
    });
  },
  ...
  watch: {
    'errors': function errors(oldVal, newVal) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-81101c24", module.exports)
  } else {
    hotAPI.update("_v-81101c24", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./components/NavBar.vue":21,"./components/SideBar.vue":22,"./components/store.js":23,"vue":17,"vue-hot-reload-api":14}],19:[function(require,module,exports){
'use strict';
...
var _all = require('./routes/all.vue');

var _all2 = _interopRequireDefault(_all);

var _cars = require('./routes/cars.vue');

var _cars2 = _interopRequireDefault(_cars);

var _search = require('./routes/search.vue');

var _search2 = _interopRequireDefault(_search);

var _searchResult = require('./routes/searchResult.vue');
...
}).app(_Main2.default).start('#app');

},{"./Main.vue":18,"./routes/all.vue":24,"./routes/cars.vue":25,"./routes/search.vue":26,"./routes/searchResult.vue":27,"SPA":1}],20:[function(require,module,exports){
'use strict';
...
var _jslinq = require('jslinq');

var _jslinq2 = _interopRequireDefault(_jslinq);
...
exports.default = {
  ...
  data: function data() {
    return {
      vehiclesToRetrieve: _store2.default.vehiclesToRetrieve,
      vehicles: _store2.default.vehicles,
      loading: false
    };
  },
  ...
  methods: {
    get: function get() {
      var self = this;
      this.loading = true;
      if (!_store2.default.vehicles.length) {
        _store2.default.getVehicles();

        self.vehicles = _store2.default.vehicles;
      }
    ...
    filter: function filter() {
      var self = this;
      var query = this.vehiclesToRetrieve;

      this.vehicles = (0, _jslinq2.default)(this.vehicles).where(function (vehicle) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-0454a9b4", module.exports)
  } else {
    hotAPI.update("_v-0454a9b4", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./store.js":23,"jslinq":10,"vue":17,"vue-hot-reload-api":14}],21:[function(require,module,exports){
'use strict';
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<nav class=\"navbar-inverse navbar navbar-fixed-top\">\n  <div class=\"container-fluid\">\n    <div class=\"navbar-header\">\n      <a class=\"navbar-brand\" v-link=\"{path: '/foo'}\">GTA Lap Tracker</a>\n    </div>\n  </div>\n</nav>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-0ddde864", module.exports)
  } else {
    hotAPI.update("_v-0ddde864", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<ul class=\"nav nav-sidebar\">\n  <li>\n    <a v-link=\"{path: '/all', activeClass: 'active', exact: true}\">\n      <i class=\"fa fa-home\"></i> All\n    </a>\n  </li>\n  <li>\n    <a v-link=\"{path: '/car', activeClass: 'active', exact: true}\">\n      <i class=\"fa fa-car\"></i> Cars\n    </a>\n  </li>\n  <li>\n    <a v-link=\"{path: '/search', activeClass: 'active', exact: false}\">\n      <i class=\"fa fa-search\"></i> Search\n    </a>\n  </li>\n</ul>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7e557978", module.exports)
  } else {
    hotAPI.update("_v-7e557978", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
exports.default = {
  ...
  bestLap: function bestLap(vehicle) {
    var bestLap = (0, _jslinq2.default)(vehicle.laps).min();
    return bestLap;
  }
};

},{"jslinq":10}],24:[function(require,module,exports){
'use strict';
...
var _VehicleList = require('../components/VehicleList.vue');
...
exports.default = {
  data: function data() {
    return {
      loading: _store2.default.loading
    };
  },
  created: function created() {
    _store2.default.vehiclesToRetrieve = 'all';
  },
  ready: function ready() {},

  components: {
    vehicleList: _VehicleList2.default
  }
};
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div id=\"allVehicles\" transition=\"slide\">\n  <div class=\"loading\" v-if=\"loading\"><i class=\"fa fa-spinner fa-spin\"></i></div>\n  <div v-else=\"\">\n    <h1>All Vehicles</h1>\n    <vehicle-list></vehicle-list>\n  </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-7bd4f39e", module.exports)
  } else {
    hotAPI.update("_v-7bd4f39e", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../components/VehicleList.vue":20,"../components/store.js":23,"vue":17,"vue-hot-reload-api":14}],25:[function(require,module,exports){
'use strict';
...
exports.default = {
  created: function created() {
    _store2.default.vehiclesToRetrieve = 'car';
  },
...
if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n<div id=\"cars\" transition=\"slide\">\n  <div>\n    <h1>Cars</h1>\n    <vehicle-list></vehicle-list>\n  </div>\n</div>\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-1861c2bf", module.exports)
  } else {
    hotAPI.update("_v-1861c2bf", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../components/VehicleList.vue":20,"../components/store.js":23,"vue":17,"vue-hot-reload-api":14}],26:[function(require,module,exports){
'use strict';
...
exports.default = {
  ...
  data: function data() {
    return {
      searchVehicle: '',
      vehicles: _store2.default.getVehicles()
    };
  },
  ...
  methods: {
    ...
    initializeTypeahead: function initializeTypeahead() {
      ...
      var ta = (0, _typeahead2.default)(el, {
        source: vehicleNames
      });
    }
  }
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-5b563ec8", module.exports)
  } else {
    hotAPI.update("_v-5b563ec8", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../components/store.js":23,"jslinq":10,"typeahead":13,"vue":17,"vue-hot-reload-api":14}],27:[function(require,module,exports){
'use strict';
...
exports.default = {
  ...
  methods: {
    getVehicle: function getVehicle(id) {
      ...
      this.vehicle = (0, _jslinq2.default)(_store2.default.vehicles).firstOrDefault(function (vehicle) {
    ...
    search: function search(model) {
      ...
      this.$http({
        ...
        var image = rawHtml.getElementsByClassName('pi-image-thumbnail')[0];
        this.image = image.src;

        var quote = rawHtml.getElementsByClassName('quote')[0].innerText;
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-4f86aef6", module.exports)
  } else {
    hotAPI.update("_v-4f86aef6", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../components/store.js":23,"jslinq":10,"vue":17,"vue-hot-reload-api":14}]},{},[19]);
